...
function App() {
  ...
  return (
    <div className="App">
      ...
      { showMessage && <div className="fixed top-8 z-50 inset-x-0 flex justify-center w-5/6 mx-auto bg-gray-800 text-white py-4 px-8 rounded-lg shadow-lg animate-fade-in">
      ...
      <h1 className= ' text-gray-800 italic pt-8 text-5xl font-bold '> Calender </h1>
      </header>
